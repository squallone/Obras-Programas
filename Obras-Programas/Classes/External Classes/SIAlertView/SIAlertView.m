...
+ (void)initialize
{
    ...
    appearance.viewBackgroundColor = [UIColor colorWithWhite:0.3 alpha:0.9];
    appearance.titleColor = [UIColor whiteColor];
    appearance.messageColor = [UIColor whiteColor];
//    appearance.titleFont = [UIFont fontWithName:kFontMenuItems size:20];
//    appearance.messageFont = [UIFont fontWithName:kFontMenuItems size:16];
...
- (id)initWithTitle:(NSString *)title andMessage:(NSString *)message
{
	self = [super init];
	if (self) {
        _transitionStyle = SIAlertViewTransitionStyleBounce;
        _cornerRadius = 10;
		_title = title;
        _message = message;
        ...
        [self addButtonWithTitle:@"Aceptar"
...
- (id)initWithoutButtonsWithTitle:(NSString *)title andMessage:(NSString *)message
{
	self = [super init];
	if (self) {
        _transitionStyle = SIAlertViewTransitionStyleBounce;
